...
Differentiële genexpressie tussen de controlegroep en de RA-groep werd geanalyseerd met behulp van het DESeq2 (versie 1.50.2) package. Hierbij werden genen met aangepaste p-waarde (padj) <0.05 als significant beschouwd. Alle genen met padj < 0.05 werden beschouwed als significant verschillend tot expressie komend en werden vervolgens gebruikt als input voor de GO-analyse. Om betekenis te geven aan de tot expressie gebrachte genen, werd een Gene Ontology (GO) analyse uitgevoerd met behulp van clusterProfiler (versie  4.18.4) [3]. Hiermee konden genen worden gegroepeerd op basis van hun betrokkenheid bij biologische processen. Daarnaast werd een KEGG pathway analyse uitgevoerd om inzicht te krijgen in welke signaalroutes en pathways betrokken zijn bij reuma. Voor verdere analyse werd specifiek gekeken naar pathway hsa04630 (JAK-STAT signaling pathway). Deze pathway werd geselecteerd omdat uit eerder onderzoek bekend is dat de JAK-STAT-signaalroute een belangrijke rol speelt bij cytokinesignalering, ontstekingsreacties en immuunactivatie bij reumatoïde artritis. Verstoringen in deze pathway staat in verband met het ontstaan van de Reuma [2]. Het flowschema van de analyse is weergegeven in figuur 1. 
<p align="center">
